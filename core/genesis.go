...
func SetupGenesisBlock(db ehcdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
...
func (g *Genesis) ToBlock(db ehcdb.Database) *types.Block {
	if db == nil {
...
func (g *Genesis) Commit(db ehcdb.Database) (*types.Block, error) {
	block := g.ToBlock(db)
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db ehcdb.Database) *types.Block {
...
func GenesisBlockForTesting(db ehcdb.Database, addr common.Address, balance *big.Int) *types.Block {
	g := Genesis{Alloc: GenesisAlloc{addr: {Balance: balance}}}
	return g.MustCommit(db)
}

// DefaultGenesisBlock returns the Ecosystem main net genesis block.
...
// DeveloperGenesisBlock returns the 'gehc --dev' genesis block. Note, this must
// be seeded with the
