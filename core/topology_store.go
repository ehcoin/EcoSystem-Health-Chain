...
func NewTopologyStore(reader chainReader, chainDb ehcdb.Database) *TopologyStore {
...
func (ts *TopologyStore) GetOriginalElect(number uint64) ([]common.Elect, error) {
	...
	minerElectNumber := lastElectNumber - man.MinerNetChangeUpTime
	validatorElectNumber := lastElectNumber - man.VerifyNetChangeUpTime
...
func (ts *TopologyStore) GetNextElect(number uint64) ([]common.Elect, error) {
	...
	minerElectNumber := NextElectNumber - man.MinerNetChangeUpTime
	validatorElectNumber := NextElectNumber - man.VerifyNetChangeUpTime
