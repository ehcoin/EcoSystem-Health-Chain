...
// Package types contains data types related to Ecosystem consensus.
package types
...
// Header represents a block header in the Ecosystem blockchain.
type Header struct {
...
// Block represents an entire block in the Ecosystem blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package ehc to track
...
// [deprecated by ehc/63]
// StorageBlock defines the RLP encoding of a Block stored in the
// state database. The StorageBlock encoding contains fields that
// would otherwise need to be recomputed.
type StorageBlock Block

// "external" block encoding. used for ehc protocol, etc.
...
// DecodeRLP decodes the Ecosystem
...
// EncodeRLP serializes b into the Ecosystem RLP block format.
