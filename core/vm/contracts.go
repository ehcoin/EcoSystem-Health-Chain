...
import (
	...
	"github.com/ecosystem/go-ecosystem/crypto/bn256"
...
// PrecompiledContractsByzantium contains the default set of pre-compiled Ecosystem
...
func (c *dataCopy) Run(input []byte, contract *Contract, evm *EVM) ([]byte, error) {
	return input, nil
}
