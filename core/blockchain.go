...
// Package core implements the Ecosystem consensus protocol.
package core
...
type BlockChain struct {
	...
	db     ehcdb.Database // Low level persistent database to store final content in
...
// available in the database. It initialises the default Ecosystem Validator and
// Processor.
func NewBlockChain(db ehcdb.Database, cacheConfig *CacheConfig, chainConfig *params.ChainConfig, engine consensus.Engine, vmConfig vm.Config) (*BlockChain, error) {
	if cacheConfig == nil {
...
func (bc *BlockChain) InsertReceiptChain(blockChain types.Blocks, receiptChain []types.Receipts) (int, error) {
	...
	for i, block := range blockChain {
		...
		if batch.ValueSize() >= ehcdb.IdealBatchSize {
