...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	db := NewDatabase(ehcdb.NewMemDatabase())
...
// account array.
func checkStateAccounts(t *testing.T, db ehcdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db ehcdb.Database, root common.Hash) error {
...
func checkStateConsistency(db ehcdb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, ehcdb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(ehcdb.Database), srcRoot)
