...
// Package state provides a caching layer atop the Ecosystem state trie.
package state
...
// StateDBs within the ecosystem protocol are used to store anything
...
func (self *StateDB) Copy() *StateDB {
	...
	for addr := range self.journal.dirties {
		// As documented [here](https://github.com/ecosystem/go-ecosystem/pull/16485#issuecomment-380438527),
