...
// Package tests implements execution of Ecosystem JSON tests.
package tests
...
func (t *BlockTest) Run() error {
	...
	chain, err := core.NewBlockChain(db, nil, config, ehcash.NewShared(), vm.Config{})
	if err != nil {
		return err
	}
	defer chain.Stop()
...
/* See https://github.com/ecosystem/tests/wiki/Blockchain-Tests-II
