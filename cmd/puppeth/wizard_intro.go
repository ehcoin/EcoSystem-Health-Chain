...
// setting up a new or managing an existing Ecosystem private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Ecosystem private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Ecosystem network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and ehcstats servers |")
	...
	log.Info("Administering Ecosystem network", "name", w.network)
