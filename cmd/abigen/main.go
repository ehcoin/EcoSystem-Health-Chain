...
import (
	...
	"github.com/ecosystem/go-ecosystem/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Ecosystem contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Ecosystem contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Ecosystem contract Solidity source to build and bind")
