...
import (
	...
	"github.com/ecosystem/go-ecosystem/cmd/evm/internal/compiler"
	...
	"github.com/ecosystem/go-ecosystem/core/vm/runtime"
...
func runCmd(ctx *cli.Context) error {
	...
	if ctx.GlobalString(GenesisFlag.Name) != "" {
		...
		statedb, _ = state.New(common.Hash{}, state.NewDatabase(ehcdb.NewMemDatabase()))
	}
