...
// Package chequebook package wraps the 'chequebook' Ecosystem smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in ehc; (auto)cashing cheques in ehc
// as well as (auto)depositing ehc to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/ecosystem/go-ecosystem/swarm/services/swap/swap"
)
...
// * depositing ehc to the chequebook
// * watching incoming ehc
...
// Cash cashes the cheque by sending an Ecosystem transaction.
