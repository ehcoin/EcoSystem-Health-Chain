...
import (
	...
	"github.com/ecosystem/go-ecosystem/accounts/usbwallet"
...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*ehcapi.SignTransactionResult, error)
...
type SignerUI interface {
	...
	OnApprovedTx(tx ehcapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*ehcapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := ehcapi.SignTransactionResult{Raw: rlpdata, Tx: signedTx}
