...
import (
	...
	"github.com/ecosystem/go-ecosystem/contracts/chequebook"
	"github.com/ecosystem/go-ecosystem/contracts/ens"
	...
	httpapi "github.com/ecosystem/go-ecosystem/swarm/api/http"
	"github.com/ecosystem/go-ecosystem/swarm/fuse"
...
func newEnsClient(endpoint string, addr common.Address, config *api.Config) (*ens.ENS, error) {
	...
	ensClient := ehcclient.NewClient(client)
...
func detectEnsAddr(client *rpc.Client) (common.Address, error) {
	...
	block, err := ehcclient.NewClient(client).BlockByNumber(ctx, big.NewInt(0))
	if err != nil {
		return common.Address{}, err
	}
