...
import (
	...
	gehcmetrics "github.com/ecosystem/go-ecosystem/metrics"
	"github.com/ecosystem/go-ecosystem/metrics/influxdb"
...
func Setup(ctx *cli.Context) {
	if gehcmetrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(gehcmetrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "swarm.", map[string]string{
				"host": hosttag,
			})
		}
	}
