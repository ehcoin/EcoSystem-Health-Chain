...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *ehcdb.MemDatabase {
	var provers []func(key []byte) *ehcdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *ehcdb.MemDatabase {
		proof := ehcdb.NewMemDatabase()
