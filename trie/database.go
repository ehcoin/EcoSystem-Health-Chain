...
type Database struct {
	diskdb ehcdb.Database // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb ehcdb.Database) *Database {
	return &Database{
		diskdb: diskdb,
...
func (db *Database) commit(hash common.Hash, batch ehcdb.Batch) error {
	// If the node does not exist, it's a previously committed node
