...
import (
	...
	"github.com/ecosystem/go-ecosystem/crypto/sha3"
...
// ecrecover extracts the Ecosystem account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Ecosystem address
...
// Ecosystem testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     ehcdb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // Ecosystem address of the signing key
...
func New(config *params.CliqueConfig, db ehcdb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Ecosystem address recovered
...
func (c *Clique) VerifySignatures(signature []common.Signature) (bool, error) {
