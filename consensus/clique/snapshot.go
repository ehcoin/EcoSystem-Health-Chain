...
func loadSnapshot(config *params.CliqueConfig, sigcache *lru.ARCCache, db ehcdb.Database, hash common.Hash) (*Snapshot, error) {
...
func (s *Snapshot) store(db ehcdb.Database) error {
