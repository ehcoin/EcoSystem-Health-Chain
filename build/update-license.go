...
var (
	...
	authorsFileHeader = "# This is the official list of go-ecosystem authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-ecosystem Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-ecosystem library"
	}
	return "the go-ecosystem library"
}
