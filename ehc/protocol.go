...
var ProtocolName = "ehc"

// ProtocolVersions are the upported versions of the ehc protocol (first is primary).
var ProtocolVersions = []uint{ehc63, ehc62}
...
// ehc protocol message codes
const (
	// Protocol messages belonging to ehc/62
	StatusMsg          = 0x00
	...
	// Protocol messages belonging to ehc/63
	GetNodeDataMsg = 0x0d
	NodeDataMsg    = 0x0e
	GetReceiptsMsg = 0x0f
	ReceiptsMsg    = 0x10
