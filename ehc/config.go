...
// DefaultConfig contains default settings for use on the Ecosystem main net.
...
func init() {
	...
	if runtime.GOOS == "windows" {
		...
		DefaultConfig.Ethash.DatasetDir = filepath.Join(home, ".ehcash")
	}
}
...
type Config struct {
	...
	// If nil, the Ecosystem main net block is used.
