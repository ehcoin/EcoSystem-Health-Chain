...
// Syncing provides information when this nodes starts synchronising with the Ecosystem network and when it's finished.
...
type SyncingResult struct {
	...
	Status  ecosystem.SyncProgress `json:"status"`
}
