...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gehc.ipc", false, filepath.Join(os.TempDir(), "gehc.ipc")},
		{"data", "gehc.ipc", false, "data/gehc.ipc"},
		{"data", "./gehc.ipc", false, "./gehc.ipc"},
		{"data", "/gehc.ipc", false, "/gehc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gehc.ipc", true, `\\.\pipe\gehc.ipc`},
		{"data", "gehc.ipc", true, `\\.\pipe\gehc.ipc`},
		{"data", `\\.\pipe\gehc.ipc`, true, `\\.\pipe\gehc.ipc`},
	}
