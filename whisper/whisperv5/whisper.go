...
// Whisper represents a dark communication interface through the Ecosystem
...
// New creates a Whisper client ready to communicate through the Ecosystem P2P network.
